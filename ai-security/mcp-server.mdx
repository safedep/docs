...
If you'd rather configure things yourself, or your agent isn't auto-detected by the CLI, here's how to set up each one manually. Each configuration needs a SafeDep API key and your tenant domain; create an API key in [SafeDep Cloud settings](https://app.safedep.io/settings/api-keys).
