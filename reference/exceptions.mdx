...
Ecosystem names are **case-insensitive**, so `PyPi`, `pypi`, and `PyPI` are all valid.

> For the current list of supported ecosystems, see the [vet source code](https://github.com/safedep/vet/blob/8acfada0d87b17500670af323e519313c1a6cd97/pkg/models/models.go#L20).
...
<CardGroup cols={2}>
  ...
  <Card title="Filtering Guide" icon="filter" href="/reference/filtering">
    Learn how to create effective filter expressions for exceptions
  </Card>
  <Card title="Build Your Own Queries" icon="search" href="/reference/build-your-own-queries">
