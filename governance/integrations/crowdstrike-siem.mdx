---
title: "Ingest Package Guard Events to CrowdStrike SIEM"
description: "Ingest SafeDep Package Guard block events into CrowdStrike SIEM."
---
...
This will start the ingest script, which polls safedep cloud api and ingest it to crowdstrike.
