...
- Provides optional [SafeDep Cloud](/governance/cloud/overview) integration for centralized policy management and reporting
...
The **GitHub Check** will fail if there is any _Verified Malicious Package_, any _Vulnerability_ or any _Risky License_.

## Appendix

### **Vulnerabilities**

- The current version of _SafeDep GitHub App_ checks for any `CRITICAL` or `HIGH` risk vulnerability.
...
- The current version of _SafeDep GitHub App_ supports these lockfiles and ecosystems:
  1. **NPM**
  - `package-lock.json`
  - `pnpm-lock.yaml`
  - `yarn.lock`
