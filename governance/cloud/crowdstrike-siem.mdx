...
description: "Forward PMG malicious-package and dependency-cooldown block events from SafeDep Cloud to a CrowdStrike SIEM HEC endpoint."
---
...
Each block event is sent to CrowdStrike as one HEC record, pretty-printed here but sent as a single line.
