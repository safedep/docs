...
Configure `vet` to authenticate with SafeDep Cloud. See [quickstart guide](/get-started/cloud-quickstart) for onboarding and authentication setup.
...
<CardGroup cols={2}>
  <Card title="Cloud Quickstart" icon="rocket" href="/get-started/cloud-quickstart">
  ...
  <Card title="Cloud Queries" icon="search" href="/get-started/cloud-quickstart#query-your-data">
