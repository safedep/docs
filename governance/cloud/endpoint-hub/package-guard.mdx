...
- Install PMG using the [quickstart](/package-security/pmg/quickstart), or [deploy it with your MDM](/package-security/pmg/mdm/overview) on a macOS, Linux, or Windows fleet
