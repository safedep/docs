...
<Info>
To follow this guide you need a SafeDep Cloud API Key and Tenant Identifier. See [Cloud Quickstart](/get-started/cloud-quickstart) on how to onboard to SafeDep Cloud and get an API key.
</Info>
...
- `vet` installed (see [quickstart](/get-started/vet-quickstart) for installation options)
...
Use SafeDep Cloud SQL queries to analyze your Terraform provider inventory. See [SafeDep Cloud Quickstart](/get-started/cloud-quickstart) for more details on the query interface.
...
<CardGroup cols={2}>
  ...
  <Card title="SafeDep Cloud Queries" icon="search" href="/get-started/cloud-quickstart#query-your-data">
