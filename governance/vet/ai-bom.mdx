...
Browse the [full signature set](https://github.com/safedep/vet/tree/main/signatures), or [write a custom signature](/governance/vet/ai-sdk-signatures) for an SDK `vet` does not recognize yet. AI is one xBOM category: the same scan also detects cryptographic, cloud, network, filesystem, and process usage (see the [vet xBOM documentation](https://github.com/safedep/vet/blob/main/docs/xbom.md)).
