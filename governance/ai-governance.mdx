...
For a product-level overview of the outcome these capabilities deliver, see the [Shadow AI solution page](https://safedep.io/shadow-ai/).
...
<CardGroup cols={2}>
  ...
  <Card title="Generate an AI BOM" icon="robot" href="/governance/vet/ai-bom">
    Produce a CycloneDX AI Bill of Materials from your source code
  </Card>
  <Card title="Custom AI SDK signatures" icon="fingerprint" href="/governance/vet/ai-sdk-signatures">
