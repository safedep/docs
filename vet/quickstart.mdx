...
<CardGroup cols={2}>
  <Card title="GitHub Integration" icon="github" href="/vet/guides/github-code-scanning">
    Setup vet with GitHub Actions and Code Scanning
  </Card>
  <Card title="GitLab Integration" icon="gitlab" href="/apps/gitlab/overview">
    Integrate vet with GitLab CI/CD pipelines
  </Card>
  <Card title="Policy Configuration" icon="shield-check" href="/vet/advanced/policy-as-code">
