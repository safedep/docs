...
[Cloud Sync](https://docs.safedep.io/cloud/sync#cloud-sync) synchronizes vet scan data and policy violations with SafeDep Cloud for centralized analysis, query and reporting.
...
Please raise an issue on the [vet-pipe GitHub repo](https://github.com/safedep/vet-bitbucket-pipe/issues) or the [vet-pipe Bitbucket mirror](https://bitbucket.org/safedep/vet-pipe/) for any support requests.
