...
If you don't have vet installed yet, follow the [quickstart guide](/vet/quickstart) to get started.
...
<CardGroup cols={2}>
  ...
  <Card title="Policy as Code Guide" icon="file-code" href="/vet/advanced/policy-as-code">
