...
> For update list, please check [vet source code](https://github.com/safedep/vet/blob/8acfada0d87b17500670af323e519313c1a6cd97/pkg/models/models.go#L20)
...
<CardGroup cols={2}>
  ...
  <Card title="Filtering Guide" icon="filter" href="/vet/advanced/filtering">
    Learn how to create effective filter expressions for exceptions
  </Card>
  <Card title="Build Your Own Queries" icon="search" href="/vet/advanced/build-your-own-queries">
    Use query workflows for exception management
  </Card>
  <Card title="Policy as Code" icon="file-code" href="/vet/advanced/policy-as-code">
