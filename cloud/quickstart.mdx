...
<Note>[GitHub App Integration](https://github.com/apps/safedep) is available for free. See [other integrations](/apps/overview) for more details</Note>
...
This guide will help you connect your vet instances to SafeDep Cloud for centralized policy management and reporting.
...
See [supported integrations](/apps/overview) for more details on how to integrate with your SDLC.
...
Once your data is syncing, query your tenant's aggregated inventory and findings —
projects, packages, endpoints, and security findings enriched with global threat
