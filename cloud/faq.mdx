...
<Steps>
  <Step title="Register Account">
    Follow the [quickstart guide](/get-started/cloud-quickstart) to register with SafeDep Cloud
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Documentation" icon="book" href="/get-started/cloud-quickstart">
