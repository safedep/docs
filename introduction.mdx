...
This is the official documentation for [safedep.io](https://safedep.io). Here you will find everything you need to know about using **SafeDep Cloud** and **vet** to safeguard your application against risky open source components.
