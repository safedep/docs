...
<CardGroup cols={2}>
  ...
  <Card title="I'm a security engineer" icon="shield-halved" href="/governance/cloud/quickstart">
    Get org-wide visibility, policy, and governance. Start with **SafeDep Cloud** and the **Endpoint Hub**.
  </Card>
</CardGroup>

<CardGroup cols={2}>
  <Card title="Scan a repository" icon="magnifying-glass" href="/governance/vet/quickstart">
