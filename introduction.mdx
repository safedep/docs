...
- **[gryph](/ai-security/gryph-overview)** - Audit trail for AI coding agents
...
<CardGroup cols={2}>
  <Card title="I'm a developer" icon="laptop-code" href="/package-security/pmg/quickstart">
    Block malicious packages at install time and in your AI coding tools. Start with **pmg**, then add CI/CD scanning with **vet**.
  </Card>
  <Card title="I'm a security engineer" icon="shield-halved" href="/get-started/cloud-quickstart">
    Get org-wide visibility, policy, and governance. Start with **SafeDep Cloud** and the **Endpoint Hub**.
  </Card>
</CardGroup>

<CardGroup cols={2}>
  <Card title="Scan a repository" icon="magnifying-glass" href="/get-started/vet-quickstart">
    Find supply-chain risk in code, dependencies, and SBOMs with vet.
  </Card>
  <Card title="Join the community" icon="discord" href="https://discord.gg/kAGEj25dCn">
