...
- Learn [why PMG is needed](/package-security/pmg/overview) for modern development
- Understand [how PMG works](/package-security/pmg/overview#about-pmg) in detail
- Join our [Discord community](https://discord.gg/kAGEj25dCn) for support
- Check out other SafeDep tools like [vet](/introduction) and [SafeDep Cloud](/governance/cloud/overview)
