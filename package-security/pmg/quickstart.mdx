...
Use Windows 10 or 11. Download `pmg_Windows_x86_64.zip` from a [v0.29.0 or later release](https://github.com/safedep/pmg/releases/latest), extract `pmg.exe`, and add its directory to your PATH. The release is x86-64 only. ARM64 runs it under emulation. 32-bit Windows is not supported.
