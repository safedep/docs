...
<Steps>
  ...
  <Step title="Attach the scripts">
    ...
    You can optionally upload `config.yml` for a machine-wide config. If you do, set `cloud.enabled: true` in it. Set the **File Destination** to `/tmp/pmg-mdm/` for each file.
  </Step>
