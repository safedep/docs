...
1. Download and extract `pmg_Windows_x86_64.zip` from [v0.29.0](https://github.com/safedep/pmg/releases/tag/v0.29.0). Windows system install requires PMG v0.29.0 or later.
