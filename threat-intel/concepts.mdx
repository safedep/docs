...
Each report has a permanent `reportId`. SafeDep updates the same report as it learns more, for example a verdict upgrade, new indicators, or a withdrawal, and never deletes it. So you can track one threat over time by its `reportId`.
