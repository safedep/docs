...
An **indicator** (IOC) is a typed observable on a report or a campaign. For example, a command-and-control domain, a file hash, a maintainer handle, or a wallet address. Its identity is the pair `(type, value)`. See the full [IndicatorType list](/threat-intel/schema).
