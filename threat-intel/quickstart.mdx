---
title: "Quickstart"
description: "Set your credentials and run your first Threat Intel Feed query with curl in a few minutes."
---

This guide takes you from zero to your first response. It uses plain JSON over HTTP with `curl`. You do not need generated code.
...
| You need | What it is |
|---|---|
| The SafeDep Threat Intel add-on | Enabled on your tenant. |
...
Repeat until `nextPageToken` comes back empty. That is the full read loop.
</Step>
</Steps>
