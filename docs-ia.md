...
| **Package Security** | Block malicious packages at install time — on dev machines and in CI | Package Manager Guard (pmg) · Endpoint Sync |
...
| `visibility/` | Visibility & Governance |
| `reference/` | Reference |
...
| `visibility/tenants-access-control` | Visibility & Governance › Access & Identity |
