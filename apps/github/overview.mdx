...
On every **Pull Requests**, SafeDep GitHub App scans the updated packages and create a detail list with analysis on:
...
Upon any failure to these reports the GitHub App **Check** will fail, protecting branch from any harmful package.

## Appendix

- **Vulnerabilities**

  - The current version of _SafeDep GitHub App_ check for any `CRITICAL` AND `HIGH` vulnerability.

- **Risky Licenses**

  - The current version of _SafeDep GitHub App_ classify these licenses as **Risky**:
